...
const Hero = () => {
  return (
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 lg:flex">
          <div className="flex w-full relative pr-20">
          ...
          <div className="sm:justify-center lg:w-[25%] mt-10 sm:w-100 md:relative  overflow-hidden rounded-full lg:absolute lg:ml-[50%]  ">
            <Image
              src={porfilePicture}
              alt="Profile"
              width={500}
